...
describe('medal count sorter', () => {
  test('sort by gold', () => {
    ...
    const sortedData = sort(data, SortingType.Gold);
  ...
  test('sort by silver', () => {
    ...
    const sortedData = sort(data, SortingType.Silver);
  ...
  test('sorting by bronze', () => {
    ...
    const sortedData = sort(data, SortingType.Bronze);
  ...
  test('sorting by total', () => {
    ...
    const sortedData = sort(data, SortingType.Total);
